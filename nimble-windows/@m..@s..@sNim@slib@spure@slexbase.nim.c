...
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_3, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(140, 9) `bufLen > 0` ", 72);
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_4, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(141, 9) `input != nil` ", 74);
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_7, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(54, 9) `L.sentinel + 1 <= L.buf.len` ", 88);
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_10, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(56, 9) `toCopy >= 0` ", 72);
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_18, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(78, 13) `s < L.buf.len` ", 75);
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_27, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(110, 9) `L.buf[pos] == \'\\r\'` ", 80);
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_29, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(97, 9) `pos <= L.sentinel` ", 78);
STRING_LITERAL(TM__k6p5NxDJat9aTyZxfZjCDJQ_32, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim(121, 9) `L.buf[pos] == \'\\n\'` ", 80);
...
N_LIB_PRIVATE N_NIMCALL(void, fillBuffer__pureZlexbase_16)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L) {
	...
	nimfr_("fillBuffer", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	charsRead = (NI)0;
	toCopy = (NI)0;
	s = (NI)0;
	oldBufLen = (NI)0;
	nimln_(54, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		...
		failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_7));
	}
	LA3_: ;
	nimln_(55, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	...
	nimln_(56, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		if (!!((((NI) 0) <= toCopy))) goto LA7_;
		failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_10));
	}
	LA7_: ;
	nimln_(57, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		NI TM__k6p5NxDJat9aTyZxfZjCDJQ_11;
		if (!(((NI) 0) < toCopy)) goto LA11_;
		nimln_(68, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	...
	LA11_: ;
	nimln_(69, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	nimln_(2552, "/home/yyoncho/Sources/nim/Nim/lib/system.nim");
	nimln_(69, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	...
	nimln_(70, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	if (nimAddInt(toCopy, charsRead, &TM__k6p5NxDJat9aTyZxfZjCDJQ_15)) { raiseOverflow(); };
	s = (NI)(TM__k6p5NxDJat9aTyZxfZjCDJQ_15);
	nimln_(71, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		...
		nimln_(72, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		(*L).buf->data[s] = 0;
		nimln_(73, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		(*L).sentinel = s;
	}
	goto LA14_;
	LA16_: ;
	{
		...
		nimln_(76, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		if (nimSubInt(s, ((NI) 1), &TM__k6p5NxDJat9aTyZxfZjCDJQ_17)) { raiseOverflow(); };
		s = (NI)(TM__k6p5NxDJat9aTyZxfZjCDJQ_17);
		{
			nimln_(77, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
			while (1) {
				nimln_(78, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
				{
					if (!!((s < ((*L).buf ? (*L).buf->Sup.len : 0)))) goto LA23_;
					failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_18));
				}
				LA23_: ;
				{
					nimln_(79, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					while (1) {
						NIM_BOOL T27_;
				...
				nimln_(80, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
				{
					if (!(((NI) 0) <= s)) goto LA31_;
					nimln_(82, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					(*L).sentinel = s;
					nimln_(83, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					goto LA19;
				}
				goto LA29_;
				LA31_: ;
				{
					...
					nimln_(87, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					oldBufLen = ((*L).buf ? (*L).buf->Sup.len : 0);
					nimln_(88, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					...
					nimln_(89, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					nimln_(2552, "/home/yyoncho/Sources/nim/Nim/lib/system.nim");
					nimln_(89, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					...
					nimln_(90, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
					{
						NI TM__k6p5NxDJat9aTyZxfZjCDJQ_22;
						NI TM__k6p5NxDJat9aTyZxfZjCDJQ_23;
						if (!(charsRead < oldBufLen)) goto LA37_;
						nimln_(91, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
						...
						nimln_(92, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
						...
						nimln_(93, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
						goto LA19;
					}
					LA37_: ;
					nimln_(94, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, skipUtf8Bom__pureZlexbase_126)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L) {
	nimfr_("skipUtf8Bom", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	nimln_(133, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		NIM_BOOL T3_;
		NIM_BOOL T4_;
		...
		LA6_: ;
		if (!T3_) goto LA7_;
		nimln_(134, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		if (nimAddInt((*L).bufpos, ((NI) 3), &TM__k6p5NxDJat9aTyZxfZjCDJQ_25)) { raiseOverflow(); };
		(*L).bufpos = (NI)(TM__k6p5NxDJat9aTyZxfZjCDJQ_25);
		nimln_(135, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, open__pureZlexbase_136)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L, tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ* input, NI bufLen, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw refillChars) {
	...
	nimfr_("open", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	nimln_(140, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		if (!!((((NI) 0) < bufLen))) goto LA3_;
		failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_3));
	}
	LA3_: ;
	nimln_(141, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		if (!!(!((input == ((tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*) NIM_NIL))))) goto LA7_;
		failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_4));
	}
	LA7_: ;
	nimln_(142, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	unsureAsgnRef((void**) (&(*L).input), input);
	nimln_(143, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	(*L).bufpos = ((NI) 0);
	nimln_(144, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	(*L).offsetBase = ((NI) 0);
	nimln_(145, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	nimCopyMem((void*)(*L).refillChars, (NIM_CONST void*)refillChars, 32);
	nimln_(146, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	...
	nimln_(147, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	if (nimSubInt(bufLen, ((NI) 1), &TM__k6p5NxDJat9aTyZxfZjCDJQ_5)) { raiseOverflow(); };
	(*L).sentinel = (NI)(TM__k6p5NxDJat9aTyZxfZjCDJQ_5);
	nimln_(148, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	(*L).lineStart = ((NI) 0);
	nimln_(149, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	(*L).lineNumber = ((NI) 1);
	nimln_(150, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	fillBuffer__pureZlexbase_16(L);
	nimln_(151, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	skipUtf8Bom__pureZlexbase_126(L);
	popFrame();
}
N_LIB_PRIVATE N_NIMCALL(NI, fillBaseLexer__pureZlexbase_74)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L, NI pos) {
	NI result;
	nimfr_("fillBaseLexer", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	result = (NI)0;
	nimln_(97, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		if (!!((pos <= (*L).sentinel))) goto LA3_;
		failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_29));
	}
	LA3_: ;
	nimln_(98, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		NI TM__k6p5NxDJat9aTyZxfZjCDJQ_30;
		if (!(pos < (*L).sentinel)) goto LA7_;
		nimln_(99, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	...
	LA7_: ;
	{
		...
		nimln_(101, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		fillBuffer__pureZlexbase_16(L);
		nimln_(102, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		if (nimAddInt((*L).offsetBase, pos, &TM__k6p5NxDJat9aTyZxfZjCDJQ_31)) { raiseOverflow(); };
		(*L).offsetBase = (NI)(TM__k6p5NxDJat9aTyZxfZjCDJQ_31);
		nimln_(103, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		(*L).bufpos = ((NI) 0);
		nimln_(104, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		result = ((NI) 0);
	}
	LA5_: ;
	popFrame();
...
N_LIB_PRIVATE N_NIMCALL(NI, handleCR__pureZlexbase_87)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L, NI pos) {
	...
	nimfr_("handleCR", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	result = (NI)0;
	nimln_(110, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		if (pos < 0 || pos >= ((*L).buf ? (*L).buf->Sup.len : 0)){ raiseIndexError2(pos,((*L).buf ? (*L).buf->Sup.len : 0)-1); }
		if (!!(((NU8)((*L).buf->data[pos]) == (NU8)(13)))) goto LA3_;
		failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_27));
	}
	LA3_: ;
	nimln_(111, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	...
	nimln_(112, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	result = fillBaseLexer__pureZlexbase_74(L, pos);
	nimln_(113, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		...
		nimln_(114, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
		result = fillBaseLexer__pureZlexbase_74(L, result);
	}
	LA7_: ;
	nimln_(115, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	(*L).lineStart = result;
	popFrame();
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NI, handleLF__pureZlexbase_100)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L, NI pos) {
	...
	nimfr_("handleLF", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	result = (NI)0;
	nimln_(121, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	{
		if (pos < 0 || pos >= ((*L).buf ? (*L).buf->Sup.len : 0)){ raiseIndexError2(pos,((*L).buf ? (*L).buf->Sup.len : 0)-1); }
		if (!!(((NU8)((*L).buf->data[pos]) == (NU8)(10)))) goto LA3_;
		failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__k6p5NxDJat9aTyZxfZjCDJQ_32));
	}
	LA3_: ;
	nimln_(122, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	...
	nimln_(123, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	result = fillBaseLexer__pureZlexbase_74(L, pos);
	nimln_(124, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	(*L).lineStart = result;
	popFrame();
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NI, getColNumber__pureZlexbase_155)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L, NI pos) {
	...
	nimfr_("getColNumber", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	result = (NI)0;
	nimln_(155, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, close__pureZlexbase_14)(tyObject_BaseLexer__MAw8rJZtJ279bVV3TWMtXSg* L) {
	nimfr_("close", "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
	nimln_(44, "/home/yyoncho/Sources/nim/Nim/lib/pure/lexbase.nim");
