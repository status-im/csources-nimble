...
N_LIB_PRIVATE N_NIMCALL(void, writeExampleIfNonExistent__nimblepkgZinit_22)(NimStringDesc* file, NimStringDesc* content) {
	...
	nimln_(17, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
	{
		...
		writeFile__stdZsyncio_622(file, content);
	}
	goto LA1_;
	LA4_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(void, createPkgStructure__nimblepkgZinit_25)(tyTuple__m4dgv18KkMuujpHOVANHbw* info, NimStringDesc* pkgRoot) {
	...
	T1_ = NIM_NIL;
	T1_ = slash___pureZos_118(pkgRoot, (*info).Field5);
	...
	LA2_: ;
	{
		...
		T8_ = NIM_NIL;
		T8_ = slash___pureZos_118(pkgRoot, (*info).Field5);
		T9_ = NIM_NIL;
		T9_ = noschangeFileExt((*info).Field0, ((NimStringDesc*) &TM__74Ly1Pltw9bii2XReJC59cDg_5));
		mainFile = slash___pureZos_118(T8_, T9_);
...
appendString(nimbleFileOptions, T10_);
	...
	LA3_: ;
	{
		...
		T12_ = NIM_NIL;
		T12_ = slash___pureZos_118(pkgRoot, (*info).Field5);
		T13_ = NIM_NIL;
		T13_ = noschangeFileExt((*info).Field0, ((NimStringDesc*) &TM__74Ly1Pltw9bii2XReJC59cDg_5));
		mainFile_2 = slash___pureZos_118(T12_, T13_);
		...
		T14_ = NIM_NIL;
		T14_ = slash___pureZos_118(pkgRoot, (*info).Field5);
		T15_ = NIM_NIL;
		T15_ = slash___pureZos_118(T14_, (*info).Field0);
		createDirD__nimblepkgZtools_94(T15_);
		nimln_(57, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
		T16_ = NIM_NIL;
		T16_ = slash___pureZos_118(pkgRoot, (*info).Field5);
		T17_ = NIM_NIL;
		T17_ = slash___pureZos_118(T16_, (*info).Field0);
		...
		nimln_(57, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
		submodule = slash___pureZos_118(T17_, T18_);
	...
	LA4_: ;
	{
		...
		T21_ = NIM_NIL;
		T21_ = slash___pureZos_118(pkgRoot, (*info).Field5);
		T22_ = NIM_NIL;
		T22_ = noschangeFileExt((*info).Field0, ((NimStringDesc*) &TM__74Ly1Pltw9bii2XReJC59cDg_5));
		mainFile_3 = slash___pureZos_118(T21_, T22_);
		...
		T24_ = NIM_NIL;
		T25_ = NIM_NIL;
		T25_ = slash___pureZos_118(pkgRoot, (*info).Field5);
		T26_ = NIM_NIL;
		T26_ = slash___pureZos_118(T25_, (*info).Field0);
...
appendString(T24_, ((NimStringDesc*) &TM__74Ly1Pltw9bii2XReJC59cDg_15));
		...
		submodule_2 = slash___pureZos_118(pkgSubDir, T27_);
...
appendString(nimbleFileOptions, T29_);
	...
	LA5_: ;
	{
		nimln_(105, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
		{
			...
			failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__74Ly1Pltw9bii2XReJC59cDg_18));
		}
		LA33_: ;
	}
	LA6_: ;
	...
	LA36_: ;
	{
		...
		pkgTestPath = slash___pureZos_118(pkgRoot, pkgTestDir);
		...
		T42_ = NIM_NIL;
		T42_ = slash___pureZos_118(pkgTestPath, T41_);
		...
		nimln_(116, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
		writeFile__stdZsyncio_622(T42_, T43_);
		nimln_(120, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
		{
			...
			T49_ = NIM_NIL;
			T49_ = slash___pureZos_118(pkgTestPath, T48_);
		...
		LA46_: ;
		{
			...
			T53_ = NIM_NIL;
			T53_ = slash___pureZos_118(pkgTestPath, T52_);
	...
	LA37_: ;
	{
		nimln_(155, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
		{
			...
			failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__74Ly1Pltw9bii2XReJC59cDg_26));
		}
		LA58_: ;
	}
	LA38_: ;
	...
	nimbleFile = slash___pureZos_118(pkgRoot, T60_);
	...
	nimln_(159, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/init.nim");
	writeFile__stdZsyncio_622(nimbleFile, T62_);
