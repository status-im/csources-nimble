...
STRING_LITERAL(TM__rm2jIEalpWUJxJEXChxPuw_15, "/home/yyoncho/Sources/nim/Nim/lib/system/iterators.nim(243, 11) `len(a) == L` the length of the seq changed while iterating over it", 131);
STRING_LITERAL(TM__rm2jIEalpWUJxJEXChxPuw_17, "/home/yyoncho/Sources/nim/Nim/lib/pure/collections/tables.nim(1143, 13) `len(t) == L` the length of the table changed while iterating over it", 141);
...
{	_nimCurFrame = getFrame();
	...
	TM__rm2jIEalpWUJxJEXChxPuw_2.status = _setjmp(TM__rm2jIEalpWUJxJEXChxPuw_2.context, 0);
	...
	nimbleFile = findNimbleFile__nimblepkgZpackageinfo_2713(T5_, NIM_TRUE);
	popSafePoint();
	}
	else {
		popSafePoint();
	...
	getPkgInfoFromFile__nimblepkgZpackageparser_2663(nimbleFile, options, NIM_FALSE, (&pkgInfo));
	...
	LA10_: ;
	{
		...
		T13_ = dotdot___stdZenumutils_94(((NI) 6), ((NI) 1));
	...
	nimln_(26, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/nimscriptexecutor.nim");
	{
		...
		hookExists = contains__nimblepkgZpackageinfo_2666(pkgInfo.preHooks, T18_);
	}
	goto LA14_;
	LA16_: ;
	{
		...
		hookExists = contains__nimblepkgZpackageinfo_2666(pkgInfo.postHooks, T20_);
	}
	LA14_: ;
...
{	result = (NIM_BOOL)0;
	...
	nimln_(40, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/nimscriptexecutor.nim");
	{
		NIM_BOOL T9_;
		T9_ = (NIM_BOOL)0;
		T9_ = isNimScript__nimblepkgZpackageparser_2712(nimbleFile, options);
		if (!!(T9_)) goto LA10_;
...
{	nimZeroMem((void*)(&newOptions), sizeof(tyObject_Options__LR5gStV09bAFaOqz9agkkZxQ));
	...
	parseCommand__nimblepkgZoptions_224((*execResult).command, (&newOptions));
	{
		NimStringDesc** arg;
		NI i;
		NI L;
		...
		L = T2_;
		{
			...
			while (1) {
				...
				parseArgument__nimblepkgZoptions_283((*arg), (&newOptions));
				...
				nimln_(243, "/home/yyoncho/Sources/nim/Nim/lib/system/iterators.nim");
				{
					...
					if (!!((T7_ == L))) goto LA8_;
					failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__rm2jIEalpWUJxJEXChxPuw_15));
				}
				LA8_: ;
			} LA4: ;
		}
				...
				while (1) {
					...
					h = res;
					{
						...
						vals = (*(*execResult).flags).data->data[h].Field2;
						{
							...
							L_3 = T21_;
							{
								...
								while (1) {
									...
									val = (&vals->data[i_2]);
									parseFlag__nimblepkgZoptions_365(flag, (*val), (&newOptions), ((tyEnum_CmdLineKind__XkdXq9atxjiuhkFFh0XYrSA) 2));
									nimln_(242, "/home/yyoncho/Sources/nim/Nim/lib/system/iterators.nim");
						...
						nimln_(1143, "/home/yyoncho/Sources/nim/Nim/lib/pure/collections/tables.nim");
						{
							...
							failedAssertImpl__stdZassertions_56(((NimStringDesc*) &TM__rm2jIEalpWUJxJEXChxPuw_17));
						}
						LA32_: ;
					}
					LA18_: ;
