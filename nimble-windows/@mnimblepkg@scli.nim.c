...
{	nimln_(66, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
	...
	LA9_: ;
	{
		...
		write__stdZsyncio_220(stdout, text);
	}
	LA7_: ;
	}BeforeRet_: ;
	popFrame();
	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			...
			while (1) {
				...
				LA44_: ;
				nimln_(112, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
				line = substr__system_8704(msg, first, T43_);
				{
					NimStringDesc* T54_;
...
appendString(T6_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_34));
		...
		yn = readLine__stdZsyncio_364(stdin);
...
appendString(T2_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_42));
	...
	default:
	{
		nimln_(194, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
		{
			...
			user = readLine__stdZsyncio_364(stdin);
...
appendString(T14_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_42));
			...
			user_2 = readLine__stdZsyncio_364(stdin);
	...
	selected = NIM_FALSE;
	{
		...
		i = ((NI) 0);
		{
			...
			while (1) {
				...
				arg = (&args[i]);
				write__stdZsyncio_220(stdout, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_47));
...
appendString(T1_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_42));
	...
	result = readLine__stdZsyncio_364(stdin);
	{
		NimStringDesc** arg;
		NI i;
		arg = (NimStringDesc**)0;
