	...
	i = ((NI) 0);
	{
		...
		eolpos = ((NI) 0);
		{
			...
			while (1) {
				...
				LA44_: ;
				nimln_(112, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
				line = substr__system_7845(msg, first, T43_);
				{
					NimStringDesc* T54_;
...
appendString(T6_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_34));
		...
		yn = readLine__systemZio_364(stdin);
...
appendString(T2_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_42));
	...
	default:
	{
		nimln_(194, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
		{
			...
			user = readLine__systemZio_364(stdin);
...
appendString(T14_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_42));
			...
			user_2 = readLine__systemZio_364(stdin);
...
{	result = NIM_NIL;
	...
	selected = NIM_FALSE;
	{
		...
		i = ((NI) 0);
		{
			...
			while (1) {
				...
				arg = (&args[i]);
				write__systemZio_220(stdout, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_47));
	...
	hideCursor__pureZterminal_222(stdout);
	{
		...
		while (1) {
			...
			setForegroundColor__pureZterminal_486(stdout, ((tyEnum_ForegroundColor__ez9ah4IgQc0AbdW68acioDg) 39), NIM_FALSE);
			{
				NI i_2;
				NimStringDesc* arg_2;
				NI i_3;
...
appendString(T13_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_50));
							writeStyled__pureZterminal_451(T13_, 1);
						}
						goto LA9_;
						LA11_: ;
						{
...
appendString(T15_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_51));
							writeStyled__pureZterminal_451(T15_, 2);
						}
						LA9_: ;
						{
							NI s;
							...
							i_4 = ((NI) 0);
							{
								...
								while (1) {
									...
									nimln_(237, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
									s = i_4;
									cursorBackward__pureZterminal_306(stdout, ((NI) 1));
						...
						nimln_(230, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
						cursorDown__pureZterminal_276(stdout, ((NI) 1));
			...
			}
			{
				...
				i_6 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln_(242, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
						i_5 = i_6;
						cursorUp__pureZterminal_261(stdout, ((NI) 1));
						nimln_(122, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/system/iterators_1.nim");
				...
				while (1) {
					{
						...
						case 3:
						{
							...
							showCursor__pureZterminal_224(stdout);
	...
	}
	{
		...
		i_8 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln_(273, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
				i_7 = i_8;
				eraseLine__pureZterminal_321(stdout);
				cursorDown__pureZterminal_276(stdout, ((NI) 1));
				nimln_(122, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/system/iterators_1.nim");
...
appendString(T1_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_42));
	...
	result = readLine__systemZio_364(stdin);
	{
		NimStringDesc** arg;
		NI i;
		arg = (NimStringDesc**)0;
...
appendString(T2_, ((NimStringDesc*) &TM__FcgmG7w9cZrrbXWqFO8NrIw_42));
	...
	default:
	{
		nimln_(299, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/cli.nim");
		{
			NIM_BOOL T6_;
			T6_ = (NIM_BOOL)0;
			T6_ = isatty__pureZterminal_632(stdout);
			if (!T6_) goto LA7_;
