...
tyProc__iFRTcmMTw1TazdzRbzql4Q Dl_2768240654_;
...
appendString(contents, T19_);
	...
	writeFile__systemZio_567(dest, contents);
...
appendString(T25_, ((NimStringDesc*) &TM__yK9aybloZA9bb1n4SolPwsJg_19));
	writeFile__systemZio_567(bashDest, T25_);
...
if (!((TM__yK9aybloZA9bb1n4SolPwsJg_2 = nimLoadLibrary(((NimStringDesc*) &TM__yK9aybloZA9bb1n4SolPwsJg_4)))
	...
	Dl_2768240654_ = (tyProc__iFRTcmMTw1TazdzRbzql4Q) nimGetProcAddr(TM__yK9aybloZA9bb1n4SolPwsJg_2, "GetVersionExA");
}
