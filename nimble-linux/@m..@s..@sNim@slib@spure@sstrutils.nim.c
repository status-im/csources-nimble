...
STRING_LITERAL(TM__JGc9b9bh2D3nTdUR7TGyq8aA_124, "0123456789ABCDEF", 16);
...
appendString((*s), a[idx_2]);
					...
					LA55_: ;
					{
						...
						T69_ = NIM_NIL;
						T69_ = substr__system_8723(formatstr, (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_27), (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_28));
...
appendString((*s), a[(NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_29)]);
				...
				case 95:
				{
					...
					T82_ = NIM_NIL;
					T82_ = substr__system_8723(formatstr, (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_33), (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_34));
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym33_ = maxsplit;
		{
			...
			while (1) {
				...
				nimln_(724, "/home/yyoncho/Sources/nim/Nim/lib/pure/strutils.nim");
				xX60gensym66_ = substr__system_8723(s, firstX60gensym33_, (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_49));
...
{	result = (NIM_BOOL)0;
	...
	if (nimSubInt(sLenX60gensym154_, suffixLenX60gensym154_, &TM__JGc9b9bh2D3nTdUR7TGyq8aA_86)) { raiseOverflow(); };
	jX60gensym154_ = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_86);
	{
		...
		while (1) {
			...
			T3_ = (NIM_BOOL)0;
			if (nimAddInt(iX60gensym154_, jX60gensym154_, &TM__JGc9b9bh2D3nTdUR7TGyq8aA_87)) { raiseOverflow(); };
			T3_ = (((NI) 0) <= (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_87));
			if (!(T3_)) goto LA4_;
			if (nimAddInt(iX60gensym154_, jX60gensym154_, &TM__JGc9b9bh2D3nTdUR7TGyq8aA_88)) { raiseOverflow(); };
			T3_ = ((NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_88) < sLenX60gensym154_);
			LA4_: ;
			if (!T3_) goto LA2;
			nimln_(70, "/home/yyoncho/Sources/nim/Nim/lib/std/private/strimpl.nim");
			{
				NI TM__JGc9b9bh2D3nTdUR7TGyq8aA_89;
				if (nimAddInt(iX60gensym154_, jX60gensym154_, &TM__JGc9b9bh2D3nTdUR7TGyq8aA_89)) { raiseOverflow(); };
				...
				if (!!(((NU8)(s->data[(NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_89)]) == (NU8)(suffix->data[iX60gensym154_])))) goto LA7_;
				result = NIM_FALSE;
				goto BeforeRet_;
			}
			LA7_: ;
			nimln_(71, "/home/yyoncho/Sources/nim/Nim/lib/std/private/strimpl.nim");
			if (nimAddInt(iX60gensym154_, ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_90)) { raiseOverflow(); };
			iX60gensym154_ = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_90);
		} LA2: ;
	}
...
{	result = (NIM_BOOL)0;
	...
	iX60gensym147_ = ((NI) 0);
	{
		...
		while (1) {
			...
			if (nimAddInt(iX60gensym147_, ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_91)) { raiseOverflow(); };
			iX60gensym147_ = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_91);
		}
	}
	}BeforeRet_: ;
	popFrame();
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuStrip)(NimStringDesc* s, NIM_BOOL leading, NIM_BOOL trailing, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw chars) {
	...
	result = substr__system_8723(s, first, last);
	popFrame();
	return result;
}
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym36_ = maxsplit;
		{
			...
			while (1) {
				...
				nimln_(739, "/home/yyoncho/Sources/nim/Nim/lib/pure/strutils.nim");
				xX60gensym67_ = substr__system_8723(s, firstX60gensym36_, (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_108));
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T12_ = result->Sup.len++;
				T13_ = NIM_NIL;
	...
	LA3_: ;
	{
		...
		i = ((NI) 0);
		{
			...
			while (1) {
				...
				T14_ = NIM_NIL;
				T14_ = substr__system_8723(s, i, (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_113));
	...
	LA6_: ;
	{
		...
		i_2 = ((NI) 0);
		{
			...
			while (1) {
				...
				T23_ = NIM_NIL;
				T23_ = substr__system_8723(s, i_2, (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_115));
...
appendString(result, by);
		...
		T24_ = NIM_NIL;
		T24_ = substr__system_8735(s, i_2);
	...
	result = NIM_NIL;
	{
		...
		eolpos = ((NI) 0);
		{
			...
			while (1) {
				...
				LA26_: ;
				nimln_(864, "/home/yyoncho/Sources/nim/Nim/lib/pure/strutils.nim");
				xX60gensym75_ = substr__system_8723(s, first, T25_);
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T31_ = result->Sup.len++;
				T32_ = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, toHexImpl__pureZstrutils_733)(NU64 x, NI len, NIM_BOOL handleNegative) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		if (nimSubInt(((NI) (len)), ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_123)) { raiseOverflow(); };
		colontmp_ = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_123);
		...
		res = colontmp_;
		{
			...
			while (1) {
				...
				if ((NU64)(n & 15ULL) < 0 || (NU64)(n & 15ULL) >= (((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_124) ? ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_124)->Sup.len : 0)){ raiseIndexError2((NU64)(n & 15ULL),(((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_124) ? ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_124)->Sup.len : 0)-1); }
				result->data[j] = ((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_124)->data[(NU64)(n & 15ULL)];
				...
				if (nimSubInt(res, ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_125)) { raiseOverflow(); };
				res = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_125);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = (NI)0;
	...
	nimln_(2026, "/home/yyoncho/Sources/nim/Nim/lib/pure/strutils.nim");
	{
		...
		if (nimSubInt((s ? s->Sup.len : 0), ((NI) (start)), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_127)) { raiseOverflow(); };
		if (!((NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_127) < (sub ? sub->Sup.len : 0))) goto LA7_;
	...
	result = ((NI) 0);
	{
		...
		if (nimSubInt(last_2, (sub ? sub->Sup.len : 0), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_128)) { raiseOverflow(); };
		if (nimAddInt((NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_128), ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_129)) { raiseOverflow(); };
		colontmp_ = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_129);
		...
		res = colontmp_;
		{
			...
			while (1) {
				...
				i = res;
				{
					...
					if (nimSubInt((sub ? sub->Sup.len : 0), ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_130)) { raiseOverflow(); };
					colontmp__3 = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_130);
					nimln_(90, "/home/yyoncho/Sources/nim/Nim/lib/system/iterators_1.nim");
					res_2 = ((NI) 0);
					{
						nimln_(91, "/home/yyoncho/Sources/nim/Nim/lib/system/iterators_1.nim");
						while (1) {
							...
							nimln_(2031, "/home/yyoncho/Sources/nim/Nim/lib/pure/strutils.nim");
							{
								...
								if (nimAddInt(i, j, &TM__JGc9b9bh2D3nTdUR7TGyq8aA_131)) { raiseOverflow(); };
								if ((NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_131) < 0 || (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_131) >= (s ? s->Sup.len : 0)){ raiseIndexError2((NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_131),(s ? s->Sup.len : 0)-1); }
								if (!!(((NU8)(sub->data[j]) == (NU8)(s->data[(NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_131)])))) goto LA22_;
							...
							LA22_: ;
							nimln_(93, "/home/yyoncho/Sources/nim/Nim/lib/system/iterators_1.nim");
							if (nimAddInt(res_2, ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_132)) { raiseOverflow(); };
							res_2 = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_132);
						} LA19: ;
					}
				} LA17: ;
				nimln_(2030, "/home/yyoncho/Sources/nim/Nim/lib/pure/strutils.nim");
				...
				LA26_: ;
				nimln_(36, "/home/yyoncho/Sources/nim/Nim/lib/system/iterators_1.nim");
				if (nimSubInt(res, ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_133)) { raiseOverflow(); };
				res = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_133);
			} LA16: ;
		}
	}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuReplaceChar)(NimStringDesc* s, NIM_CHAR sub, NIM_CHAR by) {
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			if (nimAddInt(i, ((NI) 1), &TM__JGc9b9bh2D3nTdUR7TGyq8aA_134)) { raiseOverflow(); };
			i = (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_134);
		} LA2: ;
	}
	popFrame();
	return result;
	...
	result = NIM_NIL;
	{
		...
		splitsX60gensym40_ = maxsplit;
		{
			...
			while (1) {
				...
				nimln_(762, "/home/yyoncho/Sources/nim/Nim/lib/pure/strutils.nim");
				xX60gensym71_ = substr__system_8723(s, firstX60gensym40_, (NI)(TM__JGc9b9bh2D3nTdUR7TGyq8aA_140));
				result = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3((TGenericSeq*)(result), (&NTIseqLstringT__sM4lkSb7zS6F7OVMvW9cffQ_));
				T17_ = result->Sup.len++;
				T18_ = NIM_NIL;
