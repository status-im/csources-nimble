...
{	_nimCurFrame = getFrame();
	...
	nimln_(28, "/home/yyoncho/Sources/nim/nimble/src/nimblepkg/nimscriptexecutor.nim");
	{
		...
		execHook__nimblepkgZnimscriptwrapper_255(nimbleFile, actionName, before, options, (&res));
...
{	result = (NIM_BOOL)0;
	...
	if (!(((8192 &((NU32)1<<((NU)((*options).action.typ)&31U)))!=0))) 	{ raiseFieldError2(((NimStringDesc*) &TM__rm2jIEalpWUJxJEXChxPuw_3), reprDiscriminant(((NI)(*options).action.typ) + (NI)IL64(0), (&NTIactiontype__w1V3R82mpkCDejycxLFPdg_))); } 
	execTask__nimblepkgZnimscriptwrapper_240(nimbleFile, (*options).action._typ_9.command, options, (&(*execResult)));
