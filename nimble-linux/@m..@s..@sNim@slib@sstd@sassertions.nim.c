...
N_LIB_PRIVATE N_NOINLINE(void, raiseAssert__stdZassertions_32)(NimStringDesc* msg) __attribute__((noreturn));
static N_INLINE(void, sysFatal__stdZassertions_34)(NimStringDesc* message) __attribute__((noreturn));
...
static N_INLINE(void, sysFatal__stdZassertions_34)(NimStringDesc* message) {
	...
	raiseExceptionEx((Exception*)T1_, "AssertionDefect", "sysFatal", "/home/yyoncho/Sources/nim/Nim/lib/system/fatal.nim", 53);
	popFrame();
}
N_LIB_PRIVATE N_NOINLINE(void, raiseAssert__stdZassertions_32)(NimStringDesc* msg) {
	nimfr_("raiseAssert", "/home/yyoncho/Sources/nim/Nim/lib/std/assertions.nim");
	nimln_(34, "/home/yyoncho/Sources/nim/Nim/lib/std/assertions.nim");
	sysFatal__stdZassertions_34(msg);
	popFrame();
}
N_LIB_PRIVATE N_NIMCALL(void, failedAssertImpl__stdZassertions_56)(NimStringDesc* msg) {
	nimfr_("failedAssertImpl", "/home/yyoncho/Sources/nim/Nim/lib/std/assertions.nim");
	nimln_(44, "/home/yyoncho/Sources/nim/Nim/lib/std/assertions.nim");
	raiseAssert__stdZassertions_32(msg);
	popFrame();
}
