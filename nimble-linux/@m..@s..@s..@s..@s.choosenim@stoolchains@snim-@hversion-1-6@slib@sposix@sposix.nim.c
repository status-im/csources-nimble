...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, WIFSIGNALED__posixZposix_1063)(int s) {
	...
	nimfr_("WIFSIGNALED", "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
	result = (NIM_BOOL)0;
	nimln_(576, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
...
N_LIB_PRIVATE N_NIMCALL(int, WTERMSIG__posixZposix_1054)(int s) {
	int result;
	nimfr_("WTERMSIG", "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
	result = (int)0;
	nimln_(573, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
...
N_LIB_PRIVATE N_NIMCALL(int, WEXITSTATUS__posixZposix_1047)(int s) {
	int result;
	nimfr_("WEXITSTATUS", "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
	result = (int)0;
	nimln_(572, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, WIFEXITED__posixZposix_1060)(int s) {
	NIM_BOOL result;
	int T1_;
	nimfr_("WIFEXITED", "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
	result = (NIM_BOOL)0;
	nimln_(575, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/posix/posix_linux_amd64.nim");
	T1_ = (int)0;
