...
STRING_LITERAL(TM__CZNeKGdQ8AWxD1HSDIq5DQ_2, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim(69, 12) `url.len > 0` URL must not be empty string", 125);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, prepare__pureZbrowsers_6)(NimStringDesc* s) {
	...
	nimfr_("prepare", "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
	result = NIM_NIL;
	nimln_(33, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = contains__pureZstrutils_1688(s, ((NimStringDesc*) &TM__CZNeKGdQ8AWxD1HSDIq5DQ_3));
		if (!T3_) goto LA4_;
		nimln_(34, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
		result = copyString(s);
	}
	goto LA1_;
	LA4_: ;
	{
		...
		NimStringDesc* T8_;
		NimStringDesc* T9_;
		nimln_(36, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
		T7_ = NIM_NIL;
		...
		nimln_(36, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
		T9_ = NIM_NIL;
		T9_ = absolutePath__pureZos_735(s, T8_);
...
N_LIB_PRIVATE N_NIMCALL(void, openDefaultBrowserImpl__pureZbrowsers_9)(NimStringDesc* url) {
	...
	NimStringDesc* T1_;
	TFrame* _nimCurFrame;
	nimfr_("openDefaultBrowserImpl", "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
{	_nimCurFrame = getFrame();
	nimln_(46, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
	T1_ = NIM_NIL;
	T1_ = prepare__pureZbrowsers_6(url);
	u = nospquoteShell(T1_);
	nimln_(47, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
	{
		NimStringDesc* T4_;
		NI T5_;
		T4_ = NIM_NIL;
...
appendString(T4_, u);
	...
	LA6_: ;
	{
		...
		b = NIM_NIL;
		colontmp_ = NIM_NIL;
		nimln_(48, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
			...
			while (1) {
				...
				firstX60gensym34_ = lastX60gensym34_;
				{
					...
					while (1) {
						...
						if (nimAddInt(lastX60gensym34_, ((NI) 1), &TM__CZNeKGdQ8AWxD1HSDIq5DQ_7)) { raiseOverflow(); };
						lastX60gensym34_ = (NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_7);
					} LA12: ;
				}
				...
				if (nimSubInt(lastX60gensym34_, ((NI) 1), &TM__CZNeKGdQ8AWxD1HSDIq5DQ_8)) { raiseOverflow(); };
				nimln_(48, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
				b = substr__system_7790(colontmp_, firstX60gensym34_, (NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_8));
				...
				nimln_(51, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
				...
				(void)(T20_);
				nimln_(52, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
				popSafePoint();
				goto BeforeRet_;
				popSafePoint();
				}
				...
				if (nimSubInt(splitsX60gensym34_, ((NI) 1), &TM__CZNeKGdQ8AWxD1HSDIq5DQ_10)) { raiseOverflow(); };
				splitsX60gensym34_ = (NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_10);
				nimln_(376, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/strutils.nim");
				if (nimAddInt(lastX60gensym34_, ((NI) 1), &TM__CZNeKGdQ8AWxD1HSDIq5DQ_11)) { raiseOverflow(); };
				lastX60gensym34_ = (NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_11);
			} LA10: ;
		} LA9: ;
	}
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, openDefaultBrowser__pureZbrowsers_13)(NimStringDesc* url) {
	nimfr_("openDefaultBrowser", "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
	nimln_(69, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
	{
		if (!!((((NI) 0) < (url ? url->Sup.len : 0)))) goto LA3_;
		failedAssertImpl__systemZassertions_56(((NimStringDesc*) &TM__CZNeKGdQ8AWxD1HSDIq5DQ_2));
	}
	LA3_: ;
	nimln_(70, "/home/yyoncho/.choosenim/toolchains/nim-#version-1-6/lib/pure/browsers.nim");
